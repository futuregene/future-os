...
| [Loop 控制面](loop-control-plane.zh-CN.md)（[English](loop-control-plane.md)） | `future-loop`——目标/todos/门禁/监控、should-run 内核、额度、事件溯源、交付闭环、多 agent、supervisor/worker 消息、web 看板 |
