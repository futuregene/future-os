...
更新：2026-09-04。W1–W7 后端、审批、维护与产品接入已实现；Windows11普通用户有原生、GUI核心写入、安装包生命周期及多主机历史PASS。**不是与Seatbelt等价的读写沙盒，也不是Elevated独立用户隔离。** 本页统一实现、取舍、真机操作与证据；共享规则/UI/参考见[COMMON.zh-CN.md](COMMON.zh-CN.md)。
