...
This change does not alter compaction triggers, summarization algorithms, or the
history retained in the authoritative database. It adds retrieval and conditional
usage guidance; it does not guarantee that every model will choose to retrieve
