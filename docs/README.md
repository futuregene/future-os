...
| Doc | What it covers |
|---|---|
| [CLI authorization and Loop refactor](architecture/CLI_REFACTOR.zh-CN.md) (Chinese only, on hold) | Preserved CLI/Loop and IPC isolation investigation; no longer a remote-execution prerequisite |
| [Remote execution design](architecture/REMOTE_EXECUTION_DESIGN.md) (Chinese) | SSH Linux runner, host-local skills and slash menus, target-scoped context and approval rules, desktop panels, and later WSL2 |
