...
[`../loop-control-plane.md`](../loop-control-plane.md) (operational
model).

## License & attribution

The `future-loop` crate (in `orchestration/loop/`) contains code derived from
[LoopX](https://github.com/huangruiteng/loopx) and is distributed under the
**Apache License, Version 2.0** — see [`LICENSE`](../../../orchestration/loop/LICENSE), [`NOTICE`](../../../orchestration/loop/NOTICE),
and [`UPSTREAM.md`](../../../orchestration/loop/UPSTREAM.md) for the upstream base version, the scope of
