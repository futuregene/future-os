...
pub struct StreamRequest {
    ...
    /// plus "session_created" and "session_deleted" on the global control-plane
    /// stream.
    ...
    /// "provider_config_changed", "session_created" and "session_deleted".
    #[prost(bool, tag = "6")]
...
pub struct StreamEvent {
    ...
    ///                             via global_events
    ///    session_deleted          global control-plane signal: a session was removed
    ///                             (delete_session, from any client) — carries
    ///                             {sessionId}; fired only after the session is gone
    ///                             from memory and disk, so subscribers drop their
    ///                             mirror instead of reconciling it
    ///
