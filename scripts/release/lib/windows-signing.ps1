...
.DESCRIPTION
    Dot-source this file; it defines functions only and runs nothing:
        ...
        . "$PSScriptRoot\lib\windows-signing.ps1"            # from scripts/release/
        . "$PSScriptRoot\..\release\lib\windows-signing.ps1" # from scripts/build/

    Used by scripts/release/sign-file.ps1 (the Tauri signCommand callback) and
    scripts/build/build-desktop-windows-installer.ps1.
#>
