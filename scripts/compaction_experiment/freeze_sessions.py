...
def _checkout():
    """The checkout this script lives in (…/<checkout>/scripts/compaction_experiment/x.py)."""
...
CFG = json.loads(require(
        ...
        "See scripts/compaction_experiment/README.md: create it with the session ids "
        "you want to measure.",
    ).read_text())
