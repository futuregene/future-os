...
// Usage: node scripts/measure-mobile-performance.mjs [baseline-ref]
...
await build({ entryPoints: [path.join(root, 'scripts/measure-mobile-performance.ts')], bundle: true,
