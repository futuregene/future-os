...
SCRIPT = ROOT / "scripts" / "docs" / "check-docs.py"
...
def build_tree(extra):
    ...
    (root / "scripts" / "docs" / "check-docs.py").write_text(
...
def run(root, *args):
    return subprocess.run(
        [sys.executable, "scripts/docs/check-docs.py", *args],
...
class PairScopeTests(unittest.TestCase):
    ...
    def test_non_markdown_and_root_paths_are_out_of_scope(self):
        ...
        self.assertFalse(checker.in_pair_scope("scripts/docs/check-docs.py"))
