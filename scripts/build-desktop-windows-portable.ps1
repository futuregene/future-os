...
.EXAMPLE
    pwsh scripts/build-desktop-windows-portable.ps1
    pwsh scripts/build-desktop-windows-portable.ps1 -SkipDeps -OutDir C:\builds
    pwsh scripts/build-desktop-windows-portable.ps1 -Sign
    pwsh scripts/build-desktop-windows-portable.ps1 -Sign -CertSubject "<part of the cert Subject>"
#>
[CmdletBinding()]
param(
    [switch]$SkipDeps,
