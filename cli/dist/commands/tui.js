...
async function resolveTuiEntry() {
    ...
    await assertReadableFile(entry, "TUI entry", "Build the TUI first with `cd future-os && make build-tui`.");
    return entry;
}
