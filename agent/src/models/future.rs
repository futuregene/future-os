...
/// following the shared contract in `future-rpc/proto/future.proto` ("Future Platform URL
...
mod tests {
    ...
    fn base_url_wins_over_platform_base_url() {
        // Same precedence as the GUI (future-rpc/proto/future.proto contract): the stored
