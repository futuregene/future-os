...
describe("thread row title space", () => {
  it.each([
    { compact: false, depth: 0, hasChildren: false, padding: 8, spacer: false },
    { compact: false, depth: 0, hasChildren: true, padding: 8, spacer: false },
    { compact: false, depth: 1, hasChildren: false, padding: 24, spacer: true },
    { compact: false, depth: 1, hasChildren: true, padding: 24, spacer: false },
