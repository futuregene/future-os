...
describe("safeImage", () => {
  ...
  it("previews tall images without injecting buttons into image links", () => {
    ...
    click(img);
    expect(document.querySelector("[role=dialog] img")?.getAttribute("src")).toBe("https://x/tall.png");
