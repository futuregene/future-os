...
标题空间优先：普通对话和置顶区中，无子对话的顶层行不预留展开箭头占位，子级行保留占位以保持同级标题对齐；工作区内的展开箭头复用已有左侧缩进，不额外挤占标题宽度。同时普通对话和置顶区（非工作区）的标题与高亮左缘之间保留 12px 起始留白，标题不贴边。展开箭头均保留在左侧，其他会话新增或展开子对话不改变无关顶层行的标题起点。
