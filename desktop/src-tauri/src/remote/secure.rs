...
fn confirmation(
    ...
    let body = json!({ "confirmed": true, "pairId": pair_id, "bridgeInstanceId": bridge,
        "features": ["e2ee_v2", "file_transfer_v1", "file_download_v2", "approval_tier_v1", "continue_run_v1", "prompt_receipt_v1", "session_files_v1", "skills_v1", "selective_events_v1", "workspace_pinning_v1"],
