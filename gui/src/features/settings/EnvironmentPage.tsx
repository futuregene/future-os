...
/**
 * Switch the app between the production and test platforms. A dev-build-only
 * affordance: release builds are production-locked (the tab is hidden and the
 * backend also refuses non-production switches).
 */
