...
/// contract in `future-rpc/proto/future.proto` ("Future Platform URL Resolution").
...
/// contract in `future-rpc/proto/future.proto` ("Future Platform URL Resolution") — keep
...
mod tests {
    ...
    fn base_url_wins_over_platform_base_url() {
        // Same precedence as the agent (future-rpc/proto/future.proto contract): the stored
