...
- **ER.md**：§2 关系总览 · §3 命名约定 · §4 对象（4.1 Workspace … 4.8 Approval Request / 4.9 Review Changeset / 4.10 Review File Change（含 **Shadow Review 扩展**：`review_snapshots` 表 + changeset/file_change 扩展列）… 4.20 Object Reference）· §5 第一版表清单 · §6 关键设计决策（**6.8 影子仓「上一轮变更」**）
