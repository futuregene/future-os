...
export function calculateImageRows(imageDimensions, targetWidthCells, cellDims = { widthPx: 9, heightPx: 18 }) {
    const targetWidthPx = targetWidthCells * cellDims.widthPx;
