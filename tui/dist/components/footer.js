...
export class Footer {
    ...
    render(width) {
        ...
        const tokenParts = [];
        if (this.data.tokensIn)
            tokenParts.push(fg(71, `\u2191${this.fmtTokens(this.data.tokensIn)}`));
        if (this.data.tokensOut)
            tokenParts.push(fg(71, `\u2193${this.fmtTokens(this.data.tokensOut)}`));
        if (this.data.tokensCacheR)
            tokenParts.push(fg(71, `R${this.fmtTokens(this.data.tokensCacheR)}`));
