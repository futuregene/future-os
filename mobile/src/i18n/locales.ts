  ...
  en: {
    translation: {
      ...
      connection: {
        ...
        retry: "Retry",
        errorServiceLater: "Service temporarily unavailable. Try again later. ({{code}})",
        errorServiceSupport: "Service temporarily unavailable. Contact support. ({{code}})",
        errorRateLimit: "Service is busy. Try again later. ({{code}})",
        errorPairing: "Pairing expired. Pair this device again. ({{code}})",
        errorNotFound: "The requested content is no longer available. ({{code}})",
        errorNetwork: "Network unavailable. Check your connection and try again later. ({{code}})",
        errorDeviceLater: "This device is temporarily unavailable. Try again later. ({{code}})",
        errorGeneric: "The action could not be completed. Try again later. ({{code}})",
      },
      sessions: {
        title: "Sessions",
        conversations: "Chats",
  ...
  zh: {
    translation: {
      ...
      connection: {
        ...
        errorServiceSupport: "服务暂时不可用，请联系客服（{{code}}）",
        errorRateLimit: "服务繁忙，请稍后再试（{{code}}）",
        errorPairing: "配对已失效，请重新配对（{{code}}）",
        errorNotFound: "请求的内容已不可用（{{code}}）",
        errorNetwork: "网络异常，请检查网络后稍后再试（{{code}}）",
        errorDeviceLater: "设备暂时不可用，请稍后再试（{{code}}）",
