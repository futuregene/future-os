export const resources = {
  en: {
    translation: {
      ...
      connection: {
        ...
        connectedHint: "Your phone is connected to the desktop. You can send messages and view conversations.",
        connectingHint: "Connecting to the desktop. Please wait.",
        pairAgainHint: "Pairing has expired. Open device management and scan a new QR code from the desktop.",
        checkNetworkHint: "Check your phone and computer's network connections, then try reconnecting.",
        contactSupportHint: "Contact support and include the error code shown here.",
        retryHint: "The connection is temporarily unavailable. Try again later.",
        agentUnavailable:
        ...
        statusDetails: {
          connected: { reason: "The phone is connected to the desktop", solution: "" },
          connecting: { reason: "Connecting to the desktop", solution: "Please wait" },
          waitingDesktop: { reason: "The desktop is not online yet", solution: "Open the desktop and wait for automatic connection" },
          devicePreparing: { reason: "The desktop service is not ready", solution: "Restart the desktop" },
        },
        disconnectDetails: {
          manual: { reason: "Remote control was turned off on the desktop", solution: "Enable it on the desktop, then reconnect" },
          sleep: { reason: "The computer is sleeping", solution: "Wake the computer, then reconnect" },
          exit: { reason: "The desktop app has quit", solution: "Open the desktop app, then reconnect" },
          powerOff: { reason: "The computer has shut down", solution: "Turn it on and open the desktop app, then reconnect" },
          offline: { reason: "The desktop connection was disconnected", solution: "Make sure the desktop is online, then reconnect" },
          timeout: { reason: "The desktop connection timed out", solution: "Check both devices' networks, then reconnect" },
          recoveryTimeout: { reason: "Automatic reconnection timed out", solution: "Check both devices' networks, then reconnect" },
          network: { reason: "The network connection failed", solution: "Check both devices' networks, then reconnect" },
          busy: { reason: "The connection service is busy", solution: "Reconnect later" },
          service: { reason: "The connection service is temporarily unavailable", solution: "Reconnect later" },
          support: { reason: "The connection service encountered an error", solution: "Contact support with the error code" },
          device: { reason: "The desktop service is unavailable", solution: "Restart the desktop app, then reconnect" },
          pairing: { reason: "Pairing has expired", solution: "Open desktop management and scan a new pairing code" },
          content: { reason: "The requested content is unavailable", solution: "Reconnect to refresh the list" },
          failed: { reason: "Could not connect to the desktop", solution: "Make sure the desktop is online, then reconnect" },
        },
        notConnected: "Not connected",
        manuallyDisconnectedHint: "Remote control was disconnected from the desktop. Enable it on the desktop, then reconnect here.",
      ...
      chat: {
        ...
        syncingLatest: "Syncing latest content… Displayed messages may be incomplete.",
        syncRetrying: "Latest content is not yet synced. Retrying…",
        syncWaitingNetwork: "Latest content is not yet synced. Waiting for connection…",
      ...
      failure: {
        ...
        responseUnconfirmed: "Completion could not be confirmed. Continue or retry.",
        ...
        modelPaused: "This type of model pause cannot be resumed automatically.",
        modelPausedTitle: "Model paused generation",
        providerCancelled: "The model service cancelled generation. You can retry.",
      ...
      approval: {
        ...
        escalationRequestTitle: "The model requests to run this command outside the sandbox",
      ...
      attachment: {
        ...
        save: "Save",
        share: "Share",
        openFailed: "Could not open the file in another app. You can still save or share it.",
        ...
        noHandler: "No app available to this runtime can open this file type. You can still save or share it.",
        imagesUnsupported:
  ...
  zh: {
    translation: {
      ...
      pairing: {
        title: "连接桌面端",
        description: "在桌面端打开“手机遥控”，点击“配对并启动”，然后扫描二维码。",
        permission:
      ...
      connection: {
        ...
        pairAgainHint: "配对已失效，请前往设备管理，重新扫描桌面端的配对二维码。",
        ...
        statusDetails: {
          ...
          waitingDesktop: { reason: "桌面端尚未上线", solution: "请打开桌面端并等待自动连接" },
          devicePreparing: { reason: "桌面端服务尚未就绪", solution: "请重启桌面端" },
        },
        disconnectDetails: {
          manual: { reason: "桌面端已关闭手机遥控", solution: "请在桌面端开启后重新连接" },
          sleep: { reason: "电脑已进入休眠", solution: "请唤醒电脑后重新连接" },
          exit: { reason: "桌面端已退出", solution: "请打开桌面端后重新连接" },
          powerOff: { reason: "电脑已关机", solution: "请开机并打开桌面端后重新连接" },
          offline: { reason: "与桌面端的连接已断开", solution: "请确认桌面端在线后重新连接" },
          timeout: { reason: "连接桌面端超时", solution: "请检查两端网络后重新连接" },
          recoveryTimeout: { reason: "自动重连已超时", solution: "请检查两端网络后重新连接" },
          network: { reason: "网络连接异常", solution: "请检查两端网络后重新连接" },
          busy: { reason: "连接服务繁忙", solution: "请稍后重新连接" },
          service: { reason: "连接服务暂不可用", solution: "请稍后重新连接" },
          support: { reason: "连接服务发生异常", solution: "请联系支持人员并提供错误码" },
          device: { reason: "桌面端服务暂不可用", solution: "请重启桌面端后重新连接" },
          pairing: { reason: "配对已失效", solution: "请在桌面管理中重新扫码配对" },
          content: { reason: "请求的内容已不可用", solution: "请重新连接以刷新列表" },
          failed: { reason: "未能连接到桌面端", solution: "请确认桌面端在线后重新连接" },
        },
        notConnected: "未连接",
        manuallyDisconnectedHint: "桌面端已主动断开手机遥控。请先在桌面端开启，再点击重新连接。",
        ...
        noModels: "没有可用模型",
        noModelsHint: "已连接桌面端，但还没有配置模型。请在桌面端配置模型后再回来。",
        failed: "服务不可用",
      ...
      attachment: {
        ...
        errors: {
          ...
          attachment_album_unavailable: "系统相册不可用，请启用相册应用，或使用「选择文件」。",
      ...
      update: {
        ...
        manualMessage: "发现新版本 {{version}}（当前版本 {{current}}），请前往下载并手工升级。",
        confirm: "升级",
        download: "前往下载",
        cancel: "取消",
