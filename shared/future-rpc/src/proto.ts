/**
 * Shared FutureAgent proto: the embedded schema text plus a loader configured
...
message ModelEntry {
  ...
  optional string description_en = 9;
  bool recommended = 10;
}
...
message Command {
  ...
  optional string description_zh = 4;
...
message SessionState {
  ...
  optional string parent_session_id = 30;
...
/**
 * Load the FutureAgent proto with the shared options. Returns the parsed
 * package definition ready for `grpc.loadPackageDefinition`.
 */
